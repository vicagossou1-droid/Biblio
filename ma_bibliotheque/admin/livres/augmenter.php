...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($quantite <= 0) {
        ...
        if (mysqli_stmt_execute($update_stmt)) {
            flash_set('success', 'Exemplaires augmentés avec succès');
            header('Location: ' . BASE_URL . '/admin/livres/index.php');
            exit;
        } else {
...
<h1>Ajouter des exemplaires - <?php echo esc($livre['titre']); ?></h1>
...
<div class="form">
    ...
    <form method="post">
        <div class="form-group">
            <label for="quantite">Nombre d'exemplaires à ajouter :</label>
